...
export default function ApuSection() {
  return (
    <section className="relative flex items-center justify-center px-4 sm:px-8 lg:px-15 py-12 sm:py-16 lg:py-20 w-full">
      ...
      {/* Content Container */}
      <div className="relative z-10 flex items-center justify-center gap-2.5 p-4 sm:p-6 lg:p-8 bg-[#444444]/70 border border-[#2D9ACF] backdrop-blur-[10px] rounded-[15px] max-w-4xl mx-4">
